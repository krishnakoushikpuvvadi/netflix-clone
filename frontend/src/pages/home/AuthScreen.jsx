 ...
 const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        <p className='mb-4'> Ready to wath? Enter your email to create or restart your membership.</p>
        ...
        <input
           ...
           />
           <button className='bg-red-600 text-xl lg:text-xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
            Get Started
    ...
    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
        ...
        <div className='flex-1'>
            <div className='relative'>
                ...
                <div className='flex items-center gap-2 absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
  ...
  <div className='py-10 bg-black text-white'>
    <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
        ...
        <div className='flex-1 text-center md:text-left'> 
            ...
            <p className='text-lg md:text-xl'>
                Send kids on adventures with their favorite characters in a space made just for them -- free with your memebership
             </p>
            </div>
