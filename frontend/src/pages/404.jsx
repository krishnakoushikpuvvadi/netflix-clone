...
const NotFoundPage = () => {
	return (
		<div
			className='min-h-screen bg-cover bg-center flex flex-col justify-center items-center text-white bg-black'
		...
		>
			...
			<main className='text-center error-page--content z-10 flex-grow flex flex-col items-center justify-center'>
